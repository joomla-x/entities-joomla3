<?php
/**
 * FinderTaxonomyMap Entity Declaration
 *
...
/**
 * FinderTaxonomyMap Entity Class
 */
class FinderTaxonomyMap
{
    /**
     * @var  int
     */
     ...
     * @return int
     */
    protected function setNodeId($value)
    {
        return $this->nodeId = (int)$value;
    }
}
